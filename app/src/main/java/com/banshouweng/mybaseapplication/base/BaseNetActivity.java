        ...
        jsonService.postResult(action1, headerParams, requestBody)
                ...
                .subscribe(new Observer<ResponseBody>() {
                    ...
                    public void onNext(@NonNull ResponseBody responseBody) {
                        ...
                        try {
                            String responseString = responseBody.string();
                            Logger.i("responseString", action + "********** responseString post  " + responseString);
                            callBack.success(action, new Gson().fromJson(responseString, clazz));
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
        ...
        getService.getResult(action1, headerParams, params)
                ...
                .subscribe(new Observer<ResponseBody>() {
                    ...
                    public void onNext(@NonNull ResponseBody responseBody) {
                        ...
                        try {
                            String responseString = responseBody.string();
                            Logger.i("responseString", "responseString get  " + responseString);
                            callBack.success(action, new Gson().fromJson(responseString, clazz));
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    ...
                    @Override
                    public void onError(@NonNull Throwable e) {
                        Logger.i("responseString", action + "********** responseString get  " + e.toString());
                        callBack.error(action, e);
                    }
